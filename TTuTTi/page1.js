...
function settings_Page()
{
    ...
    preface.style.marginTop = '5.5%';
    preface.style.paddingBottom = '1.5%';
    preface.style.alignItems = 'center';
    preface.style.flexDirection = 'column';
    preface.style.display = 'flex';
    infor.style.marginTop = '3.0%';
    infor.style.lineHeight = '1.4';
    preface.style.lineHeight = '1.0';
    minipage.style.marginTop = '6%';
